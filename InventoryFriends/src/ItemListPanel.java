...
public class ItemListPanel extends JPanel {
    ...
    JPanel jpILSearch;
    JTable jtItemList;
    JTextField jtfItemCode, jtfItemName, jtfItemQuantity, jtfCategory, jtfItemLocation,
    ...
    public ItemListPanel(){
        ...
        jtfCategory = new HintTextField("카테고리");
        jtfCategory.setColumns(9);
